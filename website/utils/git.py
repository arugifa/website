...
from typing import Callable, Dict, Mapping, TextIO


def diff(
        from_commit: str, to_commit: str = 'HEAD',
        shell: Callable = None, output: TextIO = sys.stdout) -> Dict[str, Path]:  # noqa: E501
