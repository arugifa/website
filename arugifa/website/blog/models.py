...
from arugifa.website import db
from arugifa.website.base.models import BaseDocument, TagList
...
class Article(BaseDocument):
    ...
    _tags = db.relationship(
        'Tag', order_by=f'Tag.uri', collection_class=TagList,
...
from arugifa.website.models import Category, Tag  # noqa: E402, F401, I202
