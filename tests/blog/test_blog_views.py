...
class TestBlogHomeView:
    ...
    def test_articles_are_sorted_by_publication_date(self, client, db):
        ...
        However, we try to cover here more edge cases, in order to keep
        acceptance tests short and simple.
        """
        today = date.today()
        ...
        # To finally check that
        # they are sorted in descending chronological order.
        expected = [
